...
public class BinaryClassRelationship implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (testRelationship.classA.uniqueName().equals(this.classA.uniqueName())
				...
				&& testRelationship.aSideMultiplicity.equals(this.aSideMultiplicity)
				&& testRelationship.bSideMultiplicity.equals(this.bSideMultiplicity)
			...
			return true;
				...
				&& testRelationship.aSideMultiplicity.equals(this.bSideMultiplicity)
				&& testRelationship.bSideMultiplicity.equals(this.aSideMultiplicity)
