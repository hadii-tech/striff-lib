...
public class RelatedComponentsGroup {
	...
	public Set<Component> components() {
		...
		for (String cmpName : mainComponents) {
			...
			/**
			 * Filter stage 3: If there is space, Repeat filter stage 1 on the newly added
			 * components representing composition/aggregation relationships.
			 */
			...
			/**
			 * Filter stage 4: If there is space, find any remaining weak relationships.
			 */
