...
public class ClarityViewsStructureDiffSVGDiagram implements ClassDiagram {
    ...
    public ClarityViewsStructureDiffSVGDiagram(ClassDiagram diagram, String language) {
