...
public class DiffPlantUMLDiagramDesciption implements PlantUMLClassDiagramDesciption {
	...
	public DiffPlantUMLDiagramDesciption(Set<Component> diagramComponents,
			Map<String, BinaryClassRelationship> binaryRelationships,
			List<BinaryClassRelationship> deletedRelationships, List<BinaryClassRelationship> addedRelationships,
			List<String> deletedComponents, List<String> addedComponents, Map<String, Component> allComponents) {
