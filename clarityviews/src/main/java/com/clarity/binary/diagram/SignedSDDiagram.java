...
public class SignedSDDiagram implements Diagram {
    ...
    private String clarityBotWebSiteText = "<text xml:space=\"preserve\" style=\"font-style:normal;font-weight:normal;font-size:14px;line-height:25px;font-family:consolas;letter-spacing:0px;word-spacing:0px;fill:#000;fill-opacity:1;stroke:none\" id=\"text3968\"><tspan id=\"tspan3966\" x=\"15\" y=\"15\" style=\"font-size:12px\">clarity_language Structure-Diff - https://clarity-bot.com </tspan></text>";
