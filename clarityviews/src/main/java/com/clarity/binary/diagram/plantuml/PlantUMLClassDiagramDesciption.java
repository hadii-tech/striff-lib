...
public class PlantUMLClassDiagramDesciption implements PlantUMLDiagramDesciption {
     ...
     */
    public PlantUMLClassDiagramDesciption(final Set<Component> diagramComponents,
