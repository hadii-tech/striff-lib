...
public final class DiagramConstants {
    ...
    public enum BinaryClassAssociation {
         ...
         */
        NONE(0, "", "-", "", ""),
        REALIZATION(6, "Implements", "-.-", "|>", "<|"), /**
         *
         */
        WEAK_ASSOCIATION(4, "Uses", "-", ">", "<"),
        ASSOCIATION(2, "Uses", "-", ">", "<");
        ...
        BinaryClassAssociation(
                final int strength,
                final String label,
                final String linkType, final String forwardLinkEndingType, String backwardLinkEndingType) {
        ...
        public
        String getAssociationLabel() {
            return associationLabel;
        }

        public
        String getyumlLinkType() {
            return yumlLinkType;
        }

        public
        String getForwardLinkEndingType() {
            return forwardLinkEndingType;
        }

        public
        String getBackwardLinkEndingType() {
            return backwardLinkEndingType;
        }
    }

    public static final String
    MULTIPLICITY_STRING_SEPERATOR =
    "..";
    ...
    public enum DefaultClassMultiplicities {
        ...
        NONE(""),
        ONETOONE("1" + MULTIPLICITY_STRING_SEPERATOR + "1"),
        ZEROTOMANY("0" + MULTIPLICITY_STRING_SEPERATOR + "*"),
        ZEROTOONE("0" + MULTIPLICITY_STRING_SEPERATOR + "1");
    ...
    public static final String PLANT_UML_DARK_THEME_STRING =
            "skinparam defaultFontName Consolas\n"
                    ...
                    + "skinparam classFontColor #b7e9fb\n"
