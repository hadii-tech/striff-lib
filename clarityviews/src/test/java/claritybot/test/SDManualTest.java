...
public class SDManualTest {
    ...
    public void structureDiffManualTest() throws Exception {
        ...
        OOPSourceCodeModel newModel = ClarityTestUtil.getGitHubRepoModel("btrajkovski", "junit4", "assert-content-equals", "d812a6ef9729a381a374907a96bfe74bdf60173e", Lang.JAVA);
