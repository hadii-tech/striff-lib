...
public class BinaryClassRelationshipTest {
	...
	public void equalBinaryClassRelationshipsTest() {
		...
		ExternalClassLink link = new  ExternalClassLink(cmpA,cmpB, null, null, null, BinaryClassAssociation.COMPOSITION);
	...
	public void unEqualBinaryClassRelationshipsByName() {
		...
		ExternalClassLink link = new  ExternalClassLink(cmpB, cmpA, null, null, null, BinaryClassAssociation.COMPOSITION);
		BinaryClassRelationship relA = new BinaryClassRelationship(link);
		ExternalClassLink link2 = new  ExternalClassLink(cmpA, cmpC, null, null, null, BinaryClassAssociation.COMPOSITION);
	...
	public void unequalBinaryClassRelationshipsByAssociation() {
		...
		ExternalClassLink link = new  ExternalClassLink(cmpB, cmpA, null, null, null, BinaryClassAssociation.COMPOSITION);
		BinaryClassRelationship relA = new BinaryClassRelationship(link);
		ExternalClassLink link2 = new  ExternalClassLink(cmpB, cmpA, null, null, null, BinaryClassAssociation.AGGREGATION);
		BinaryClassRelationship relB = new BinaryClassRelationship(link2);
		assert(relA.hashCode() != relB.hashCode());
	}
}
